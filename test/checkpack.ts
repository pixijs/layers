...
var bunnyTexture = PIXI.Texture.fromImage("http://pixijs.io/examples/required/assets/basics/bunny.png");

function updateBunny(bunny: any) {
	bunny.x += bunny.vx;
	bunny.y += bunny.vy;
...
function createBunny() {
	var bunny : any = new PIXI.Sprite(bunnyTexture);
